...
<div class="container" style="margin-top: 150px; margin-bottom:200px;">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="background-color:#173A7A; ; color:#ffff ; padding:15px; ">{{ __('Mot de passe oublié') }}</div>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="row mb-0 d-flex justify-content-center">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="background-color:#173A7A; ; color:#ffff ; border-color:#173A7A;">
                                    {{ __('Envoyer') }}
                                </button>
                            </div>
                        </div>
