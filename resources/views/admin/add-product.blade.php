                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text"  class="form-control input-default" value="{{old('designation')}}" name="designation" id="designation" placeholder="designation" >
                            </div>
                            <div class="form-group col-md-6">
                                <label>Désignation 2:</label>
                                <input type="text"  class="form-control input-default" value="{{old('seconde_designation')}}" name="seconde_designation" id="seconde_designation" placeholder="designation" >
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Marque :</label>
                                <input type="text"  class="form-control input-default" value="{{old('marque')}}" name="marque" id="marque" placeholder="marque" >
                            </div>
                            <div class="form-group col-md-6">
